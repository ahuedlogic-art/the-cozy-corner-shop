  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Wait a moment for isAdmin to update
        setTimeout(() => {
          navigate("/admin");
        }, 500);
      }
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden gradient-hero">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-12">
          ...
          <p className="text-muted-foreground text-center max-w-sm">
            Access your dashboard to manage products, orders, and analytics
          </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-xl bg-info/20 flex items-center justify-center mx-auto mb-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full h-12 rounded-xl gradient-primary text-primary-foreground hover:opacity-90"
              disabled={loading}
            >
